...
export default function CancelOrders() {
  ...
  // ✅ Cancelled orders fetch: all orders এনে cancelled filter
  ...
  try {
    ...
    console.error("Cancelled order fetch error:", error);
      ...
      <div className="mb-4 flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
        <div>
          ...
          <p className="text-sm text-gray-500">
            যেসব অর্ডার cancel করা হয়েছে, সেগুলো এখানে দেখাবে।
          </p>
        </div>
        ...
        <div className="flex items-center gap-2">
          <div className="relative">
            ...
            <input
              ...
              className="pl-9 pr-3 py-2 rounded-lg border bg-white focus:outline-none focus:ring-2 focus:ring-rose-500 text-sm w-72"
            />
          </div>
          <button
          ...
          <table className="min-w-full text-sm">
            ...
            <tbody className="divide-y divide-gray-100">
              {filtered.map((o) => {
                ...
                return (
                  <tr key={o._id} className="hover:bg-rose-50/30 transition">
      ...
      <div className="absolute left-1/2 top-1/2 w-[92vw] max-w-3xl -translate-x-1/2 -translate-y-1/2 rounded-2xl bg-white shadow-xl border">
        ...
        <div className="p-5 space-y-4 max-h-[70vh] overflow-auto">
          ...
          <div className="rounded-xl border border-rose-200 bg-rose-50 p-3 text-sm text-rose-800">
            ✅ This order is already <b>cancelled</b>.
          </div>
        </div>
